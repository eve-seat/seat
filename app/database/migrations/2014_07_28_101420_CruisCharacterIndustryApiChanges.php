...
class CruisCharacterIndustryApiChanges extends Migration {
	...
	public function up()
	{
		...
		DB::table('character_industryjobs')->truncate();

		// Remove Old Colums
		Schema::table('character_industryjobs', function(Blueprint $table)
		{
