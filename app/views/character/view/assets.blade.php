                      ...
                      @foreach ($column as $asset)
                        ...
                        <tbody style="border-top:0px solid #FFF">
                          <tr class="item-container">
                            ...
                            <td>
                              <span data-toggle="tooltip" title="" data-original-title="{{ number_format($asset['volume'], 0, $settings['decimal_seperator'], $settings['thousand_seperator']) }} m3">
                          ...
                          <tbody style="border-top:0px solid #FFF; display: none;" class="tbodycontent">
                            ...
                            @foreach ($asset['contents'] as $content)
                              ...
                              <tr class="hidding">
                                ...
                                <td>
                                  <span data-toggle="tooltip" title="" data-original-title="{{ number_format($content['volume'] * $content['quantity'], 0, $settings['decimal_seperator'], $settings['thousand_seperator']) }} m3">
