...
<div class="row">
    <div class="col-md-6">
        <div class="box box-solid box-primary">
            ...
            <div class="box-body">
                <h4>If your totally stuck, have feature ideas etc, use the following channels to get into contact!</h4>
                <ul>
                    ...
                    <li><a href="https://github.com/eve-seat/seat/tree/master/docs">Documentation</a> vir install &amp; upgrade guides</li>
