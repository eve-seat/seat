...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <meta property="og:title" content="SeAT Email" />
  </head>
    ...
    <center class="wrapper" style="display: table;table-layout: fixed;width: 100%;min-width: 620px;-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;background-color: #1e1e1e">
      <table class="preheader" style="border-collapse: collapse;border-spacing: 0;width: 100%;background-color: #161616">
        <tbody>
          ...
          <tr>
            <td class="preheader-buffer" style="padding: 0;vertical-align: top;background-color: #1e1e1e;font-size: 20px;line-height: 20px" colspan="2">&nbsp;</td>
          </tr>
        </tbody>
      </table>
                ...
                <tbody>
                  <tr>
                    <td class="column" style="padding: 0;vertical-align: top;text-align: left">
                      <table class="contents" style="border-collapse: collapse;border-spacing: 0;width: 100%;background-color: #212a32">
                        <tbody>
                          <tr>
                                ...
                                <tbody>
                                  <tr>
                                    <td class="padded" style="padding: 0;vertical-align: top;padding-left: 40px;padding-right: 40px;text-align: left">
                                      ...
                                      <h1 style="Margin-top: 0;font-weight: normal;color: #3d88fd;font-family: sans-serif;font-size: 30px;Margin-bottom: 16px;line-height: 44px">
                                        @if (trim($__env->yieldContent('email_title')))
                                          @yield('email_title')
                                        @else
                                          Untitled Email!
                                        @endif
                                ...
                                <tbody>
                                  <tr>
                                    <td class="padded" style="padding: 0;vertical-align: top;padding-left: 40px;padding-right: 40px;text-align: left">
                                      ...
                                      {{-- if the email has botton actions, yield them here --}}
                                      @yield('button_action')
                ...
                <tbody>
                  <tr>
                    <td class="campaign" style="padding: 0;vertical-align: top;text-align: left;color: #e6e6e6;font-family: sans-serif;font-size: 12px;line-height: 20px">
                      {{-- Check that we have a unsubscribe token --}}
                      @if(isset($unsubscribe_token))
                        <div>
                          This email was generated by SeAT {{ Config::get('seat.version') }} at <a href="{{ url('/') }}">{{ url('/') }}</a> on {{ Carbon\Carbon::now() }}<br>
                          You are receiving this email because you have notifications enabled in your profile.
                        </div>
                        <div>
                          <span>
                            <span class="block">
                      ...
                      @else
                        <div>
                          This email was generated by SeAT {{ Config::get('seat.version') }} at <a href="{{ url('/') }}">{{ url('/') }}</a> on {{ Carbon\Carbon::now() }}</div>
                      @endif
                    </td>
                    <td class="social" style="padding: 0;vertical-align: top;color: #e6e6e6;text-align: left;font-family: sans-serif;text-transform: uppercase;width: 190px">
                      <div class="padded" style="padding-left: 40px;padding-right: 40px;Margin-left: 20px;padding: 0">

                        <div style="Margin-bottom: 10px">
                          <a style="color: #e6e6e6;border-bottom: none;display: block;font-size: 10px;letter-spacing: 0.15em;line-height: 12px;text-decoration: none;font-weight: bold" href="https://github.com/eve-seat/seat" target="_blank">
                            <img style="border: 0;-ms-interpolation-mode: bicubic;vertical-align: middle" src="https://i.imgur.com/8wWKkDx.png" alt="" width="38" height="30">
                            <span style="mso-text-raise: 11px">SeAT on Github</span>
                          </a>
                        </div>
